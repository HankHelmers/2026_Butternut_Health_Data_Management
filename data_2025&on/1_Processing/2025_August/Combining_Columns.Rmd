...
Combine some columns for variables shared between alive and dead individuals 


# Combining Columns 
Here I combine the variables that are shared between alive and dead individuals. Currently, those variables are seperate due to seperate questions required on the form. However, since the values are measuring the same thing and there is another column distinguishing between alive and dead, it will simplify the dataset to combine these. 
