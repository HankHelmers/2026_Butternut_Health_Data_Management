---
title: "2025_June_July_Unique_Type_Conversion"
...
# Adjustments from form structure
These are data changes required by the form structure. For instance, if "visible_canker" is "No" then canker percentages are skipped by the form and left as NA. Instead, these should all be 0. In the case of June/July 2025, this also includes parsing the additional text allowed in the height, DBH, and densiometer entries.

Thus, this space implements implicit updates to data values, due to the forms structure.

## Height: Text to numeric

Converting all the height texts into feet measurements
...
## Densiometer: Text to numeric

### a. Densiometer to numeric
...
## Epicormics: Numeric to Yes/No

In the later versions of the survey, the epicormic question changed from a number how many epicormics to a Yes or No. Here, I make that adjustment.
