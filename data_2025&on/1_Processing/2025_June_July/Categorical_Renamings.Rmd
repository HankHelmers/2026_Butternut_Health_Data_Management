---
title: "2025_June_July_Categorical_Renamings"
...
First, convert all Yes responses into "Seedling" and Nos to "Adult". 
```{r}
...
Second, set the seedling/adult for the first two days (06-05, 06-06) based on presence of DBH and confirmation with the photos. 

Here is a link where I verify with photos, linking to the photos: 
https://docs.google.com/document/d/1jjsbuttnxnvHx3UyVWdrAe0-vcaKLf-qhb9dDDVGpV8/edit?tab=t.0#heading=h.74kcmgv1kkh9
```{r}
june_health_assess <- june_health_assess %>% mutate(adult_or_seedling = case_when(
