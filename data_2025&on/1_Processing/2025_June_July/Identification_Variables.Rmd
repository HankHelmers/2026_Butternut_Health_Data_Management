...
## Timestamp
Converting Timestamp data to the 'Date' data type
```{r}
...
# Straight-forward Type Conversion
...
```{r cleaning_height_2, message=FALSE, warning=FALSE}
